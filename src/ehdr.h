...
*                                                           *
* NE ran on several operating systems, including MSDOS and  *
* Acorn's RISC OS. There are still vestiges of these past   *
* glories in the way the code is organized and in some of   *
* the conditional compilation macros. However, this version *
* is the result of a big tidy-up to make the Unix version   *
* buildable in the standard "configure" manner. It has been *
...
extern uschar ch_tab2[];               /* and regular printing characters */
...
extern void    debug_writelog(char *, ...) PRINTF_FUNCTION;
...
extern linestr *cmd_ReChange(linestr *, uschar *, int, BOOL, BOOL, BOOL, BOOL *);
extern void    cmd_recordchanged(linestr *, int);
extern void    cmd_saveback(void);
extern BOOL    cmd_yesno(char *, ...) PRINTF_FUNCTION;
...
extern void    error_printf(char *, ...) PRINTF_FUNCTION;
...
extern BOOL    file_streamout(uschar *);
extern BOOL    file_written(uschar *);
extern int     file_writeline(linestr *, FILE *);

extern void    init_buffer(bufferstr *, int, uschar *, uschar *, FILE *, FILE *, int);
extern BOOL    init_init(FILE *, uschar *, int, uschar *, BOOL);
...
extern void    line_insertch(linestr *, int, uschar *, int, int);
...
extern void    scrn_rdline(BOOL, BOOL, uschar *);
...
extern void    sys_after_interrupted_fgets(BOOL, uschar *);
extern uschar *sys_argstring(uschar *);
extern void    sys_beep(void);
extern uschar *sys_checkfilename(uschar *, BOOL);
...
extern int     sys_fcomplete(uschar *, int, int *);
extern FILE *sys_fopen(uschar *, uschar *, int *);
...
extern BOOL    sys_makespecialname(int, uschar *);
extern void    sys_mprintf(FILE *, char *, ...) FPRINTF_FUNCTION;
extern int     sys_rc(int);
extern void    sys_runscreen(void);
extern void    sys_runwindow(void);
extern void    sys_setfiletype(uschar *, int);
...
extern void    sys_window_display_linenumber(uschar *);
extern void    sys_window_display_text(uschar *);
...
extern int     sys_window_start_off(uschar *);
extern void    sys_window_topline(int);
extern BOOL    sys_window_yesno(BOOL, uschar *, uschar *, ...);
#endif
