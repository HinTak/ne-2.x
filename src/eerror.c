...
{ rc_disaster, FALSE, US"Ran out of store: %d bytes unavailable\n" },
...
/* 5-9 */
{ rc_serious,  FALSE, US"Failed to open file \"%s\"\n" },
...
{ rc_serious,  FALSE, US"Cannot extract wild strings - regular expression match too complicated\n" },
/* 40-44 */
...
{ rc_serious,  FALSE, US"%s mark already set\n" },
...
{ rc_serious,  FALSE, US"The current buffer is a stream buffer; %s is not allowed\n" },
/* 55-59 */
...
{
uschar *CR = (msgs_fid == stdout || msgs_fid == stderr)? "\r": "";
...
static uschar *flagchars = "pbehlnrsuvwx";
