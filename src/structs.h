...
typedef struct buffer {
  ...
  /* The only windowing version that was (previously) supported was for the
  Acorn RiscOS operating system. If any others ever get supported (not very
  ...
  uschar *windowtitle;       /* window title bar text */ 
...
typedef struct qsstr {
  ...
  uschar *fsm;                 /* finite state machine for R */
